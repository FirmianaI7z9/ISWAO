<?php
  ...
  $pre = $pdo->prepare("SELECT * FROM streams ORDER BY start_at ASC;");
  $pre->execute();
...
<body>
  ...
  <div class="basic-container">
    <h3 class="basic-h3">Edit Stream</h3>
  ...
  <div class="basic-container">
    <?php
      ...
      echo implode('<hr>', array_map('format', $streams));
    ?>
  </div>
  ...
  <script>
    ...
    function senddata() {
      console.log('sending...');
      var val = { "table" : "streams", "id" : 0, "arg" : [] };
      var dit = document.getElementsByClassName('dit');
      var set = 11;
